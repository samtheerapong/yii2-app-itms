 ...
 * @property float|null $monitor_size ขนาดจอภาพ
...
class Monitors extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['asset_number', 'serial', 'port_connected'], 'string', 'max' => 45],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'monitor_size' => Yii::t('app', 'ขนาดจอภาพ'),
    ...
    {
        return $this->hasMany(SystemUser::class, ['monitor_main' => 'id']);
    }
    ...
    {
        return $this->hasMany(SystemUser::class, ['monitor_secondary' => 'id']);
    }
}
